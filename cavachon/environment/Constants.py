class Constants:
  ...
  CONFIG_FIELD_MODEL_COMPONENT_LATENT = 'latent'
  CONFIG_FIELD_MODEL_COMPONENT_N_LATENT_DIMS = 'n_latent_dims'
  CONFIG_FIELD_MODEL_COMPONENT_N_PRIORS = 'n_priors'
  CONFIG_FIELD_MODEL_COMPONENT_N_ENCODER_LAYERS = 'n_encoder_layers'
  CONFIG_FIELD_MODEL_COMPONENT_N_DECODER_LAYERS = 'n_decoder_layers'
  CONFIG_FIELD_MODEL_COMPONENT_REQUIRED = [
    CONFIG_FIELD_MODALITY
  ]
  CONFIG_FIELD_MODEL_COMPONENT_MODALITIES_REQUIRED = [
    'name'
  ]