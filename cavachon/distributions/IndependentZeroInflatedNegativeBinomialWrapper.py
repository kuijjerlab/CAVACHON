...
class IndependentZeroInflatedNegativeBinomialWrapper(DistributionWrapper):
  def __init__(self, pi_logits, mean, dispersion):
    ...
    self._parameters.setdefault('pi', tf.keras.activations.softmax(pi_logits)[...,0])
