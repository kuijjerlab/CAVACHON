...
class AttributionAnalysis:
  ...
  def compute_delta_x(
    ...
    ----------
    component : str
        the outputs of the component to used.
  ...
  def compute_integrated_gradient(
    ...
    for batch, batch_delta_x in zip(dataloader, delta_x_split):
      outputs = self.model(batch, training=sampling)
      
      # need to store conditioned_on_z, and conditioned_on_z_hat to mdata (or to Model)
